...
(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.topojson));
	...
	*/
	...
	const useMeteors = () => {
	  const [data, setData] = react.useState(null);
	  react.useEffect(() => {
	    csv$1(csvUrl, row).then(setData);
	  }, []);
	  return data;
	};

	const projection$1 = geoEqualEarth();
	const path = geoPath(projection$1);
	const Marks = ({
	  worldMap: {
	    land,
	    interiors
	  ...
	  children: [/*#__PURE__*/jsxRuntime.jsx("path", {
	  ...
	  }), land.features.map(feature => /*#__PURE__*/jsxRuntime.jsx("path", {
	    className: "land",
	    d: path(feature)
	    ...
	    const [x, y] = projection$1([d.longitude, d.latitude]);
	    console.log(x, y);
	...
	const App = () => {
	  ...
	  return /*#__PURE__*/jsxRuntime.jsx("svg", {
	    width: width,
	    height: height,
	    children: /*#__PURE__*/jsxRuntime.jsx(Marks, {
	      worldMap: worldMap,
	      meteors: meteors
	    })
	  });
	...
	reactDom.render( /*#__PURE__*/jsxRuntime.jsx(App, {}), rootElement);
